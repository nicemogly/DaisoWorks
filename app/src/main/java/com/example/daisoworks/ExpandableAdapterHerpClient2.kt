        ...
        with(holder){
            with(clientList1[position]){
             ...
             //   binding.tvClientItemName.text = this.clientItemName
                ...
                if(this.expand2) binding.viewMoreBtn.setImageResource(R.drawable.ic_arrow_drop_up) else binding.viewMoreBtn.setImageResource(R.drawable.ic_arrow_drop_down)
